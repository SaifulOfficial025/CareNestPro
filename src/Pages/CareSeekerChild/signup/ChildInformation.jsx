      ...
      <div className="w-full max-w-4xl mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="space-y-6">
          ...
          <div className="border-t border-gray-200 pt-6 mt-6">
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Age of child 1</label>
                <input 
                  type="text" 
                  placeholder="DD-MM-YYYY"
                  className="w-full p-3 border border-gray-300 rounded-md bg-white text-gray-900"
                  value={formData.child1Age}
                  onChange={(e) => updateFormData('child1Age', e.target.value)}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Gender of child 1</label>
                <select 
                  className="w-full p-3 border border-gray-300 rounded-md bg-white text-gray-900"
                  value={formData.child1Gender}
                  onChange={(e) => updateFormData('child1Gender', e.target.value)}
                >
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Age of child 2</label>
                <input 
                  type="text" 
                  placeholder="DD-MM-YYYY"
                  className="w-full p-3 border border-gray-300 rounded-md bg-white text-gray-900"
                  value={formData.child2Age}
                  onChange={(e) => updateFormData('child2Age', e.target.value)}
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Gender of child 2</label>
                <select 
                  className="w-full p-3 border border-gray-300 rounded-md bg-white text-gray-900"
                  value={formData.child2Gender}
                  onChange={(e) => updateFormData('child2Gender', e.target.value)}
                >
                  <option>Select gender</option>
                  <option>Male</option>
                  <option>Female</option>
