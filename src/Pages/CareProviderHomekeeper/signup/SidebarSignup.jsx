...
function SidebarSignup({ activeStep = 1 }) {
  const steps = [
    ...
    {
      id: 3,
      name: "Child care details",
      desc: "Provide your child care information",
      icon: (
        <BsExclamationOctagonFill className="text-[#00b3a4] h-5 w-5"/>
      ),
    },
    ...
    {
      id: 5,
      name: "Elderly care details",
      desc: "Provide your elderly care information",
      icon: (
        <BsExclamationOctagonFill className="text-[#00b3a4] h-5 w-5"/>
      ),
    },
    {
      id: 6,
      name: "Housekeeping details",
      desc: "Provide your housekeeping information",
      icon: (
        <BsExclamationOctagonFill className="text-[#00b3a4] h-5 w-5"/>
      ),
    },
